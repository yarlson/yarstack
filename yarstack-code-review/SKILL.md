---
name: yarstack-code-review
description: >-
  Use when reviewing local code changes before a PR: review my changes/code,
  check my work, security review, review before push; rank bugs, security, perf,
