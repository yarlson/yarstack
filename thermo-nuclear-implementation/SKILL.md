---
name: thermo-nuclear-implementation
description: >-
  ...
  duplicate helpers, brittle orchestration, any trap a thermo-nuclear
  code-quality review block. Trigger: "implement this so strict review finds
  nothing", "build brutally clean", "avoid review traps while coding", "ship
  code under thermonuclear quality bar".
---

# Thermo-Nuclear Implementation
