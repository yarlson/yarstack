# yarstack-draft-pr-shipping

Draft PR shipping creates a branch, commits and pushes changes, opens a draft pull request, waits for CI, fixes red builds, and iterates until the checks are green.
