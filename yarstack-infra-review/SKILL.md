---
name: yarstack-infra-review
description: >-
  Use when reviewing infra or IaC changes before plan, apply, or deploy:
  Terraform, deploy config, cloud config, network exposure, IAM/RBAC,
  destructive changes, secrets, and cost.
context: fork
---
